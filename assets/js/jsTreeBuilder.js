...
function QueryTreeBuilder(containerID, fieldsDict) {
    ...
    root.html('<ul class="tree"><li id="dndjqb_root" class="dndjqb_group dndjqb_droppable">Root&emsp;&emsp;<button class="dndjqb_add btn qb-btn btn-success btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i> <i class="fa fa-code-fork" aria-hidden="true"></i></button><button class="dndjqb_addGroup btn qb-btn btn-info btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i> <i class="fa fa-object-group" aria-hidden="true"></i></button><button id="reset"  class="btn qb-btn btn-warning btn-sm">&nbsp;<i class="fa fa-undo" aria-hidden="true"></i>&nbsp;</button><ul></ul></li></ul>');
...
QueryTreeBuilder.prototype = {
    ...
    buttonString: '<br/><button class="dndjqb_add btn qb-btn btn-success btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i> <i class="fa fa-code-fork" aria-hidden="true"></i></button><button class="dndjqb_addGroup btn qb-btn btn-info btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i> <i class="fa fa-object-group" aria-hidden="true"></i></button><button class="dndjqb_remove btn qb-btn btn-danger btn-sm">&nbsp;<i class="fa fa-minus-circle" aria-hidden="true"></i> <i class="fa fa-code-fork" aria-hidden="true"></i></button>',
